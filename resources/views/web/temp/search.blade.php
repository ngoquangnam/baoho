...
<head>
   <link href="{{ asset('web/images/banner/matna.jpg') }}" rel="shortcut icon" type="image/x-icon"/>
    <title>Cửa hàng bảo hộ lao động Đức Sơn</title>
    <!--/tags -->
    <meta HTTP-EQUIV="Content-Language" content="vi">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="description"
          content="Đồ Bảo Hộ chất lượng cao số lượng lớn, Đồ bảo hộ Đức Sơn luôn đặt chất lượng và uy tín lên hàng đầu "/>
    <meta name="keywords"
          content="Đồ bảo hộ chất lượng cao, đồ bảo hộ uy tín, đồ bảo hộ lao động, bảo hộ lao động đức sơn, @foreach($categories as $category){{ $category->name }}, @foreach($category->subCategories as $sub_category){{ $sub_category->name }}, @endforeach @endforeach"/>
                ...
                <div class="css-treeview">
                    ...
                    <ul class="tree-list-pad">
                        @foreach($categories as $index => $category)
                            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i><a data-toggle="collapse"
