            ...
            <div class="resp-tabs-container">
                ...
                <div class="tab1">
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m1.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m1.jpg') }}" alt="" class="pro-image-back">
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m2.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m2.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m3.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m3.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m4.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m4.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m5.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m5.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m7.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m7.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m6.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m6.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/m8.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/m8.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="tab2">
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w1.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w1.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w2.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w2.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w3.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w3.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w4.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w4.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w5.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w5.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w6.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w6.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w7.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w7.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset('web/images/w8.jpg') }}" alt="" class="pro-image-front">
                                <img src="{{ asset('web/images/w8.jpg') }}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="brands_products">
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="http://project.test/shopping/brand/9"> <span class="pull-right">(2)</span>Apple</a>
                                </li>
                                <li><a href="http://project.test/shopping/brand/4"> <span class="pull-right">(1)</span>Asus</a>
                                </li>
                                <li><a href="http://project.test/shopping/brand/8"> <span class="pull-right">(0)</span>Dell</a>
                                </li>
                                <li><a href="http://project.test/shopping/brand/10"> <span class="pull-right">(3)</span>Sony</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="shipping text-center">
                        <img src="http://project.test/public/images/home/shipping.jpg') }}" alt="">
                    </div>
                </div>
            </div>
