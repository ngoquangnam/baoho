                                                    ...
                                                    <ul class="multi-column-dropdown">
                                                        @foreach($category->subCategories as $key => $sub_category)
                                                            @if($key>=$i && $key<$i+8)
                                                                ...
                                                                @endphp
                                                                <li>
                                                                    <a href="{{ route('showCategories', ['slug' => $slug.'-'.$sub_category->id]) }}">{{ $sub_category->name }}</a>
                                                                </li>
                                                            @endif
                                                        @endforeach
                                                    </ul>
                            ...
                            <li class=" menu__item">
                                <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                                    <form action="#" method="post" class="last">
                                        <button class="w3view-cart" type="button" data-toggle="modal"
                                                data-target="#exampleModalLong"><i class="fa fa-cart-arrow-down"
