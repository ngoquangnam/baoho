                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($colors as $index => $color)
                                                    <tr>
                                                        <th scope="row">{{ $index + 1 }}</th>
                                                        <td>
                                                            <div style="width: 30px; height: 30px;background-color: {{ $color->color }};"></div>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($sizes as $index => $size)
                                                    <tr>
                                                        ...
                                                        <td>{{ $size->size }}</td>
                                                        <td>
                                                            <form action="{{ route('admin.size.delete', $size->id) }}"
                                                                  method="post">
                                                                @csrf
                                        ...
                                        <div class="x_content">
                                            <br/>
                                            <form class="form-horizontal form-label-left input_mask" method="post"
                                                  action="{{ route('admin.material.store') }}">
                                                @csrf
                                                <div class="form-group">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form class="form-horizontal form-label-left input_mask"
                                                  action="{{ route('admin.subCategory.store') }}" method="post">
                                                @csrf
                                                <div class="form-group">
