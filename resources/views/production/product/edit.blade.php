    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form  class="form-horizontal form-label-left" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" class="form-product" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tên sản phẩm <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12"  name="name" value="{{ old('name', isset($product) ? $product->name : null) }}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="select2_single form-control" tabindex="-1" onchange="selectCategory(this)" id="category" name="category_id">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="select2_single form-control" tabindex="-1" id="subCategory" name="sub_category_id">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <label>
                      <input type="checkbox" class="flat" value="{{ $color->id }}" name="color[]"  @foreach($product->colors as $pc)
                        @if($color->id  == $pc->id)
                        {{'checked'}}
                        @endif
                        @endforeach> {{ $color->color }}
                    </label>
                  </div>
                    @endforeach
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <div class="checkbox form-check form-check-inline">
                    <label>
                      <input type="checkbox" class="flat"value="{{ $material->id }}" name="material[]"  @foreach($product->materials as $pm)
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <div class="checkbox form-check form-check-inline">
                    <label>
                      <input type="checkbox" class="flat"value="{{ $size->id }}" name="size[]"  @foreach($product->sizes as $ps)
                        @if($size->id  == $ps->id)
                        {{'checked'}}
                        @endif
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" id="last-name" required="required" class="form-control col-md-7 col-xs-12"  name="price" value="{{ old('price', isset($product->price) ? $product->price : 'null' ) }}">
          </div>
          </div>
          <div class="form-group">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Nhà sản xuất: </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="producer" value="{{ old('producer', isset($product->producer) ? $product->producer : 'null' ) }}">
              </div>
          </div> 

          <div class="form-group">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Thời gian bảo hành:</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text"  name="warranties" value="{{ old('warranties', isset($product->warranties) ? $product->warranties : 'null' ) }}">
              </div>
          </div>
