    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form  class="form-horizontal form-label-left" action="{{ route('admin.product.store') }}" method="POST" class="form-product" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <label>
                      <input type="checkbox" class="flat" value="{{ $color->id }}" name="color[]">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <div class="checkbox form-check form-check-inline">
                    <label>
                      <input type="checkbox" class="flat"value="{{ $material->id }}" name="material[]" > {{  $material->name  }}
                    </label>
                  </div>
                    @endforeach
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12" style="display: inline-flex">
                    ...
                    <div class="checkbox form-check form-check-inline">
                    <label>
                      <input type="checkbox" class="flat"value="{{ $size->id }}" name="size[]" > {{ $size->size }}
                    </label>
                  </div>
                    @endforeach
                </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" id="last-name" required="required" class="form-control col-md-7 col-xs-12"  name="price">
          </div>
          </div>
          <div class="form-group">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Nhà sản xuất: </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="producer" >
              </div>
          </div> 
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text"  name="warranties">
              </div>
          </div>
