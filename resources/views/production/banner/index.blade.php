            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br/>
                            <form class="form-horizontal form-label-left" action="{{ route('admin.banner.store') }}"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tiêu đề
                                        chính <span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tiêu đề nhỏ
                                ...
                                <div class="form-group">
                                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Tiêu đề
                                        phụ </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Chọn
                                        ảnh</label>
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($banners as $index => $banner)
                                    <tr>
                                        ...
                                        <td style="height: 100px; width: 150px;"><img src="{{ asset($banner->image) }}"
                                                                                      class="img" style="height: 100%;">
                                        </td>
                                        ...
                                        <td class="banner"><a href="{{ route('admin.banner.edit', $banner->id) }}"
