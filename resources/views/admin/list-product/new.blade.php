    ...
    <div class="col-12">
        ...
        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="category_id"  class="select-admin" onchange="selectCategory()" id="category">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $color->id }}" name="color[]">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $size->id }}" name="size[]">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $material->id }}" name="material[]">
