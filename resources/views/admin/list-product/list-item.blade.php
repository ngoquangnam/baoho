        ...
        <form v-bind:action="action" method="POST">
            ...
            <div class="form-group">
                <input type="text" name="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                       placeholder="Sửa" v-model="message">
            </div>
                        ...
                        <tr>
                            ...
                            <th>
                                <button class="btn btn-success"
                                        v-on:click="click('{{ $color->color }}', '{{ $color->id }}', 'colors')">Edit
                                </button>
                            </th>
                            <th>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($sizes as $size)
                        <tr>
                            ...
                            <th>
                                <button class="btn btn-success"
                                        v-on:click="click('{{ $size->size }}', '{{ $size->id }}', 'sizes')">Edit
                                </button>
                            </th>
                            <th>
                                <button class="btn btn-danger">delete</button>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($materials as $material)
                        <tr>
                            ...
                            <th>
                                <button class="btn btn-success"
                                        v-on:click="click('{{ $material->name }}', '{{ $material->id }}', 'materials')">
                                    Edit
                                </button>
                            </th>
                            <th>
