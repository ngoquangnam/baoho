    ...
    <div class="col-md-7 mid-content-top">
        <div class="middle-content">
            ...
            <div id="owl-demo" class="owl-carousel text-center">
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="{{ asset('admin/images/na.jpg') }}" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="{{ asset('admin/images/na1.jpg') }}" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="{{ asset('admin/images/na2.jpg') }}" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="{{ asset('admin/images/na.jpg') }}" alt="name">
                </div>
