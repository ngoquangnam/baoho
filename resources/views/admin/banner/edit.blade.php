...
@section('content-banner')
    ...
    <div class="col-12">
        ...
        <br>
        <form action="{{ route('admin.banner.update', $banner->id) }}" method="POST" class="form-product" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="form-group row">
                <label  class="col-sm-2 col-form-label">Tiêu đề chính</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="title" value="{{ old('title', isset($banner->title) ? $banner->title : 'null') }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="discount" value="{{ old('discount', isset($banner->discount) ? $banner->discount : 'null') }}">
                </div>
            </div>
            <div class="form-group row">
                <label  class="col-sm-2 col-form-label">Tiêu đề phụ</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="sub_title" value="{{ old('sub_title', isset($banner->sub_title) ? $banner->sub_title : 'null') }}">
                </div>
            </div>
