    ...
    <div class="horz-grid">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th scope="row" class="table-image"><img src="{{ asset($billDetail->product->images[0]->image) }}" class="img"></th>
                ...
                <th scope="row"><a href="{{ route('admin.bill.edit', $billDetail->id) }}" class="btn btn-primary">Sửa</a></th>
            </tr>
            @endforeach
            </tbody>
        </table>
